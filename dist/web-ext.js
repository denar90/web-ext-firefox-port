...
class FirefoxDesktopExtensionRunner {
  ...
  async startFirefoxInstance() {
    ...
    if (firefoxPort) {
      ...
      let runCleanup = this.runCleanup.bind(this); // TODO mock running info. Turn into something real or allow
      ...
      this.runningInfo = {
        ...
        firefox: {
          kill: runCleanup,
          stderr: new events__WEBPACK_IMPORTED_MODULE_5___default.a(),
          stdout: new events__WEBPACK_IMPORTED_MODULE_5___default.a()
        }
      };
    } else {
      const binaryArgs = [];
...
/* harmony import */ var path__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! path */ "path");
/* harmony import */ var path__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(path__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var fx_runner__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! fx-runner */ "fx-runner");
/* harmony import */ var fx_runner__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(fx_runner__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var firefox_profile__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! firefox-profile */ "firefox-profile");
/* harmony import */ var firefox_profile__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(firefox_profile__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var mz__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! mz */ "mz");
/* harmony import */ var mz__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(mz__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var es6_promisify__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! es6-promisify */ "es6-promisify");
/* harmony import */ var es6_promisify__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(es6_promisify__WEBPACK_IMPORTED_MODULE_6__);
...
const defaultAsyncFsStat = mz__WEBPACK_IMPORTED_MODULE_5__["fs"].stat.bind(mz__WEBPACK_IMPORTED_MODULE_5__["fs"]);
...
async function run(profile, {
  fxRunner = fx_runner__WEBPACK_IMPORTED_MODULE_3___default.a,
 ...
 */
async function isDefaultProfile(profilePathOrName, ProfileFinder = firefox_profile__WEBPACK_IMPORTED_MODULE_4___default.a.Finder, fsStat = mz__WEBPACK_IMPORTED_MODULE_5__["fs"].stat) {
  ...
  const readProfiles = es6_promisify__WEBPACK_IMPORTED_MODULE_6___default()(finder.readProfiles, finder);
  await readProfiles();
...
function defaultCreateProfileFinder({
  userDirectoryPath,
  FxProfile = firefox_profile__WEBPACK_IMPORTED_MODULE_4___default.a
} = {}) {
  const finder = new FxProfile.Finder(userDirectoryPath);
  const readProfiles = es6_promisify__WEBPACK_IMPORTED_MODULE_6___default()(finder.readProfiles, finder);
  const getPath = es6_promisify__WEBPACK_IMPORTED_MODULE_6___default()(finder.getPath, finder);
...
async function useProfile(profilePath, {
  ...
  const profile = new firefox_profile__WEBPACK_IMPORTED_MODULE_4___default.a({
...
async function copyProfile(profileDirectory, {
  app,
  configureThisProfile = configureProfile,
  copyFromUserProfile = firefox_profile__WEBPACK_IMPORTED_MODULE_4__["copyFromUserProfile"],
  customPrefs = {}
} = {}) {
  const copy = es6_promisify__WEBPACK_IMPORTED_MODULE_6___default()(firefox_profile__WEBPACK_IMPORTED_MODULE_4___default.a.copy);
  const copyByName = es6_promisify__WEBPACK_IMPORTED_MODULE_6___default()(copyFromUserProfile);
...
async function installExtension({
  ...
  try {
    ...
    if (Object(_errors__WEBPACK_IMPORTED_MODULE_9__["isErrorWithCode"])('ENOENT', error)) {
      ...
      await mz__WEBPACK_IMPORTED_MODULE_5__["fs"].mkdir(profile.extensionsDir);
    } else {
      throw error;
    }
  }
...
`).help('help').alias('h', 'help').env(envPrefix).version(version).demandCommand(1, 'You must specify a command').strict();
  ...
  program.command('build', 'Create an extension package from source', commands.build, {
    ...
    'firefox-port': {
      alias: 'P',
      describe: 'Attach to a running Firefox on this developer tools ' + 'port. To do so, open the developer toolbar and enter ' + 'e.g. `listen 6060`. This flag usually does not need to ' + 'be set and is only for advanced use.',
      demand: false,
      type: 'number'
    },
...
/* harmony import */ var es6_promisify__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! es6-promisify */ "es6-promisify");
/* harmony import */ var es6_promisify__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(es6_promisify__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _errors__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../errors */ "./src/errors.js");
...
const defaultAsyncMkdirp = es6_promisify__WEBPACK_IMPORTED_MODULE_2___default()(mkdirp__WEBPACK_IMPORTED_MODULE_1___default.a);
const defaultAsyncFsAccess = mz__WEBPACK_IMPORTED_MODULE_0__["fs"].access.bind(mz__WEBPACK_IMPORTED_MODULE_0__["fs"]);
async function prepareArtifactsDir(artifactsDir, {
  asyncMkdirp = defaultAsyncMkdirp,
  asyncFsAccess = defaultAsyncFsAccess
} = {}) {
  try {
    const stats = await mz__WEBPACK_IMPORTED_MODULE_0__["fs"].stat(artifactsDir);
    ...
    try {
      await asyncFsAccess(artifactsDir, mz__WEBPACK_IMPORTED_MODULE_0__["fs"].W_OK);
    } catch (accessErr) {
...
class TempDir {
  ...
  create() {
    const createTempDir = es6_promisify__WEBPACK_IMPORTED_MODULE_2___default()(tmp__WEBPACK_IMPORTED_MODULE_1___default.a.dir, {
      multiArgs: true
    });
...
/* harmony import */ var zip_dir__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! zip-dir */ "zip-dir");
/* harmony import */ var zip_dir__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(zip_dir__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var es6_promisify__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! es6-promisify */ "es6-promisify");
/* harmony import */ var es6_promisify__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(es6_promisify__WEBPACK_IMPORTED_MODULE_1__);


const zipDir = es6_promisify__WEBPACK_IMPORTED_MODULE_1___default()(zip_dir__WEBPACK_IMPORTED_MODULE_0___default.a);
